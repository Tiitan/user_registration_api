...
def test_services_use_shared_password_hasher_instance() -> None:
    ...
    registration_service = RegistrationService(uow_factory=None, email_dispatcher=None)  # type: ignore[arg-type]
    activation_service = ActivationService(uow_factory=None, email_dispatcher=None)  # type: ignore[arg-type]
