...
class ActivationCodeRepository:
    ...
    async def create_code(self, *, cursor: DictCursor, user_id: int, code: str) -> int:
    ...
    async def get_latest_for_update(self, *, cursor: DictCursor, user_id: int) -> ActivationCodeRecord | None:
    ...
    async def increment_attempt_count(self, *, cursor: DictCursor, activation_code_id: int) -> None:
    ...
    async def mark_used(self, *, cursor: DictCursor, activation_code_id: int) -> None:
    ...
    async def mark_sent(self, *, cursor: DictCursor, activation_code_id: int) -> None:
    ...
    async def count_undelivered(self, *, cursor: DictCursor) -> int:
    ...
    async def count_stale_activation_codes(self, *, cursor: DictCursor, retention_hours: int) -> int:
    ...
    async def delete_stale_activation_codes(self, *, cursor: DictCursor, retention_hours: int) -> int:
