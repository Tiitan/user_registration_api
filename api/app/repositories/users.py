...
class UserRepository:
    ...
    async def get_by_email_for_update(self, *, cursor: DictCursor, email: str) -> UserRecord | None:
    ...
    async def create_pending_user(self, *, cursor: DictCursor, email: str, password_hash: str) -> int:
    ...
    async def update_pending_password(self, *, cursor: DictCursor, user_id: int, password_hash: str) -> None:
    ...
    async def mark_user_as_active(self, *, cursor: DictCursor, user_id: int) -> None:
    ...
    async def count_stale_pending_users(self, *, cursor: DictCursor, retention_hours: int) -> int:
    ...
    async def delete_stale_pending_users(self, *, cursor: DictCursor, retention_hours: int) -> int:
